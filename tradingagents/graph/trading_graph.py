...
class TradingAgentsGraph:
    ...
    def _fetch_returns(
        ...
        For A-share tickers (ending in .SS/.SZ/.BJ), uses CSI300 (000300.SS)
        as the alpha benchmark instead of SPY.
        ...
        try:
            ...
            # A股用沪深300，美股用SPY作为alpha基准
            is_a_stock = ticker.endswith((".SS", ".SZ", ".BJ"))
            benchmark_ticker = "000300.SS" if is_a_stock else "SPY"
